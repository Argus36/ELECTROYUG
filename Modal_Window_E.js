...
const Electrolaboratory_Leave_Request_Right_A = document.querySelector(".electrolaboratory .leave_request .right .a");
Electrolaboratory_Leave_Request_Right_A.addEventListener('click', function () {
    Block();
});

const Electrolaboratory_Leave_Request_Left_Button = document.querySelector(".electrolaboratory .leave_request .left .button");
Electrolaboratory_Leave_Request_Left_Button.addEventListener('click', function () {
    const Electrolaboratory_Leave_Request_Left_H3 = document.querySelector(".electrolaboratory .leave_request .left .h3");
    Electrolaboratory_Leave_Request_Left_H3.remove();
    const Electrolaboratory_Leave_Request_Left_Hr = document.querySelector(".electrolaboratory .leave_request .left .hr");
    Electrolaboratory_Leave_Request_Left_Hr.remove();
    const Electrolaboratory_Leave_Request_Left_Input_2 = document.querySelectorAll(".electrolaboratory .leave_request .left .input");
    for (const Electrolaboratory_Leave_Request_Left_Input of Electrolaboratory_Leave_Request_Left_Input_2){
        Electrolaboratory_Leave_Request_Left_Input.remove();
    }
    const Electrolaboratory_Leave_Request_Left_Textarea = document.querySelector(".electrolaboratory .leave_request .left .textarea");
    Electrolaboratory_Leave_Request_Left_Textarea.remove();
    Electrolaboratory_Leave_Request_Left_Button.remove();

    const Electrolaboratory_Leave_Request_Left = document.querySelector(".electrolaboratory .leave_request .left");
    Electrolaboratory_Leave_Request_Left.className = "Left";
    const Text_Send = document.createElement('p');
    Text_Send.className = "Text_Send";
    Text_Send.innerHTML = "Спасибо за отправку !"
    Electrolaboratory_Leave_Request_Left.appendChild(Text_Send);
});